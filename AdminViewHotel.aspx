<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminViewHotel.aspx.cs" Inherits="AdminViewHotel" %>
  ...
  <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex">Administrator View Hotel</h5>
       ...
       <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        OnCancelCommand="DataList1_CancelCommand" DataKeyField="hid" onselectedindexchanged="DataList1_SelectedIndexChanged" >
            ...
            <ItemTemplate>
               ...
               <%--<td>
               <asp:Button class="btn btn-info" ID="btn1" style="background-color:#e52b34;" runat="server" CommandName="Select"  Text="Approve" /> 
               </td>--%>
            </tr>
