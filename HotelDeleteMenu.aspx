<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HotelDeleteMenu.aspx.cs" Inherits="HotelDeleteMenu" %>
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex">Hotel Delete Menu</h5>
           ...
           <div class="col-12 stretch-card grid-margin">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <asp:DataList ID="DataList1" runat="server" OnEditCommand="DataList1_EditCommand" OnCancelCommand="DataList1_CancelCommand" DataKeyField="hmid" onselectedindexchanged="DataList1_SelectedIndexChanged" >
            ...
            <ItemTemplate>
               ...
               <td>
                ...
                <td>
               <asp:Image ID="imgEmp" runat="server" Width="50px" Height="50px" ImageUrl='<%# Bind("img") %>'/><br />
               </td>
               <td>
