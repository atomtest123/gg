<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HotelViewParkingSlot.aspx.cs" Inherits="HotelViewParkingSlot" %>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<br />--%>
            ...
            <%--  <div class="col-lg-6 grid-margin stretch-card">--%>
                <div class="card">
                <%--  <div class="card-body">--%>
                    <h4 class="card-title">Hotel View Parking Slots</h4>
                      <br />
                    <br />
