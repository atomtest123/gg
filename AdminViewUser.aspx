    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex">Administrator View User</h5>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        OnCancelCommand="DataList1_CancelCommand" DataKeyField="uid" onselectedindexchanged="DataList1_SelectedIndexChanged" >
          ...
          <%--
               <td>
               <asp:Button class="btn btn-info" ID="btn1" runat="server" style="background-color:#e52b34;" CommandName="Select"  Text="Delete" /> 
               </td>--%>
            </tr>
