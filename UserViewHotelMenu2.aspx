<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserViewHotelMenu2.aspx.cs" Inherits="UserViewHotelMenu2" %>
         ...
         <br />
          <div class="container-xxl py-5">
            <div class="container">
                ...
                <asp:Label ID="Label6" runat="server" Text="Select Hotel:" Font-Names="Arial" 
             Font-Size="Medium"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="DropDownList1" 
                 runat="server" Width="225px" Height="29px" AutoPostBack="True" 
                              ...
                              &nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <asp:Label ID="Label1" runat="server" Text="Select Food Type:" Font-Names="Arial" 
             Font-Size="Medium"></asp:Label>
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                        <asp:DataList ID="DataList2" runat="server" DataKeyField="hmid" 
                                            style="width: 400px;" onselectedindexchanged="DataList2_SelectedIndexChanged">
                                          <ItemTemplate>
                                          <br />
                                          <br />
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded" src='<%# Eval("img") %>' alt="" style="width: 100px;">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span><%# Eval("fname") %></span>
                                                <span class="text-primary">Rs <%# Eval("price") %>/-</span>
                                            </h5>
                                            <small class="fst-italic">Hotel: <%# Eval("huname") %></small>
