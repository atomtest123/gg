...
public partial class AdminDeleteHotel : System.Web.UI.Page
{
    ...
    protected void DataList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string sss = "update hreg set status=5 where hid=" + id + "";
        ob1.exec(sss);
        ...
        string r = "2";
        string s1 = "update Login set status=5 where Username='" + uname + "'";
        ob1.exec(s1);
        BindData();
