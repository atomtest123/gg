<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HotelAddMenu.aspx.cs" Inherits="HotelAddMenu" %>
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex">Hotel Add Menu</h5>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <asp:Label ID="Label22" runat="server" Text="Food Type:" Font-Names="Arial" 
             Font-Size="Medium"></asp:Label>
                 ...
                 runat="server" Width="225px" Height="29px" >
                           ...
                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                              &nbsp;&nbsp;&nbsp;<br />
         <br />
        <asp:Label ID="Label14" runat="server" Text="Food Course:" Font-Names="Arial" 
             Font-Size="Medium"></asp:Label>
        ...
        <asp:Label ID="Label4" runat="server" Text="Food Name:" Font-Names="Arial" 
             Font-Size="Medium"></asp:Label>
       &nbsp;<asp:TextBox 
        ...
        <asp:Label ID="Label19" runat="server" Text="Quantity:" Font-Names="Arial" 
             Font-Size="Medium"></asp:Label>
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox 
        ...
        <asp:Label ID="Label20" runat="server" Text="Price:" Font-Names="Arial" 
             Font-Size="Medium"></asp:Label>
                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox 
                                  ID="TextBox15" runat="server" Height="26px" Width="225px"></asp:TextBox> 
          ...
          <asp:Label ID="Label21" runat="server" Text="Food Image:" Font-Bold="False" 
             Font-Names="Arial" Font-Size="Medium"></asp:Label>
