...
public partial class HotelDeleteMenu : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        string cmdstr = "select * from hmenu where status=0 and huname= '" + Session["huname"] + "' ";
    ...
    protected void DataList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string sss = "delete hmenu where hmid=" + id + "";
        ob1.exec(sss);
