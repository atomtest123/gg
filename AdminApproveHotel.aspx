<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminApproveHotel.aspx.cs" Inherits="AdminApproveHotel" %>
...
<body>
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex">Administrator Approve Hotel</h5>
        ...
        OnCancelCommand="DataList1_CancelCommand" DataKeyField="hid" onselectedindexchanged="DataList1_SelectedIndexChanged" >
            ...
            <ItemTemplate>
             ...
             <%--  <td>
               ...
               <td>
               <asp:Button class="btn btn-outline-danger btn-fw" ID="btn1"  runat="server" CommandName="Select"  Text="Approve" /> 
               </td>
            </tr>
    ...
    <!-- container-scroller -->
    <!-- plugins:js -->
    <script src="./temp1/vendors/js/vendor.bundle.base.js"></script>
    <!-- endinject -->
    <!-- Plugin js for this page -->
    <script src="./temp1/vendors/chart.js/Chart.min.js"></script>
    <script src="./temp1/vendors/moment/moment.min.js"></script>
    <script src="./temp1/vendors/daterangepicker/daterangepicker.js"></script>
    <script src="./temp1/vendors/chartist/chartist.min.js"></script>
    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="./temp1/js/off-canvas.js"></script>
    <script src="./temp1/js/misc.js"></script>
    <!-- endinject -->
    <!-- Custom js for this page -->
    <script src="./temp1/js/dashboard.js"></script>
