<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserViewCart.aspx.cs" Inherits="UserViewCart" %>
      ...
      <div class="container-fluid page-body-wrapper">
          ...
          <%--      <div class="card card-secondary">--%>
            ...
            <ItemTemplate>
                        ...
                        <tr>
                          ...
                          <td> <asp:Image ID="imgEmp" runat="server" Width="50px" Height="50px" ImageUrl='<%# Bind("img") %>'/><br /></td>
                           <td class="text-success"> Rs.<%# Eval("price")%>/-</td>
                            <td> <%# Eval("nitem")%></td>
                              <td>
               <asp:Button  ID="btn1"  runat="server" CommandName="Select"  Text="Delete" /> 
               </td>
                        </tr>
              ...
              <%--</div>--%>
                ...
                <asp:Label ID="Label2" runat="server" Text="Total Amount:" Font-Names="Arial" 
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox 
                   ...
                   <br />
                              ...
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
          &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button 
                 ID="Button5" class="btn btn-outline-danger btn-fw" runat="server" Height="40px" Text="Book Order" onclick="Button5_Click"  
        Width="225px"/> &nbsp;&nbsp;
