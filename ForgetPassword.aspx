...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="VisistorViewFoodMenu.aspx" class="nav-link">Our Specialities</a></li>
	...
	<section class="ftco-section ftco-wrap-about ftco-no-pb ftco-no-pt">
						...
						<div class="col-md-12 col-lg-7">
							<div class="heading-section mt-5 mb-4">
								<div class="pl-lg-3 ml-md-5">
									<span class="subheading">Forget Password</span>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox2" runat="server"  Height="29px" Width="225px" ></asp:TextBox> &nbsp;&nbsp;&nbsp;<asp:Button 
                 ID="Button3" runat="server" class="btn btn-white py-3 px-4" BorderColor="#CC3300" BorderStyle="Solid" Height="50px" Width="125px"  Text="Get" onclick="Button3_Click" />
             <br />
             <br />
          <asp:Label ID="Label3" runat="server" Text="Security Question:"></asp:Label>
        &nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox1" runat="server" 
                 Width="225px"  Height="29px" Enabled="False"></asp:TextBox> &nbsp;&nbsp;&nbsp;
        <br />
        <br />
       <asp:Label ID="Label4" runat="server" Text="Answer:"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox3" runat="server"  Height="29px" Width="225px" ></asp:TextBox>
        <br />
         <br />
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button 
                 ID="Button1" runat="server" class="btn btn-white py-3 px-4" BorderColor="#CC3300" BorderStyle="Solid" Height="50px" Text="Get password" onclick="Button1_Click" Width="229px"/>
                 <br />
         <br />
         <asp:Label ID="Label1" runat="server" Text="Password:"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox4" runat="server"  Height="29px" Width="225px" ></asp:TextBox>
        <br />
         <br />
