<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminReplyComplaints.aspx.cs" Inherits="AdminReplyComplaints" %>
   ...
   <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex">Administrator Reply Complaints</h5>
