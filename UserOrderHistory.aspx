<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserOrderHistory.aspx.cs" Inherits="UserOrderHistory" %>
    ...
    <div class="container-scroller">
          ...
          <%--      <div class="card card-secondary">--%>
                  <span class="card-body d-lg-flex align-items-center">
                   <form id="form1" runat="server">
                     ...
                     <div style="Width:1200px;text-align:left;padding-left: 20px;">
              <div class="row">
                        ...
                        <tr>
                          ...
                          <td><%# Eval("timeslot")%></td>
                           ...
                           <td><%# Eval("fdate")%></td>
                            <td><%# Eval("tamount")%></td>                        
                              <td>
               <asp:Button  ID="btn1" class="btn btn-outline-danger btn-fw" runat="server" CommandName="Select"  Text="Review" /> 
               </td>
                 <td>
               <asp:Button  ID="Button1" class="btn btn-outline-danger btn-fw" runat="server" CommandName="edit"  Text="Download Bill" /> 
               </td>
                        </tr>
                ...
                <br />
                    <br />
                <asp:Label ID="Label2" runat="server" Text="Comment About Hotel:" Font-Names="Arial" 
      ...
      <asp:TextBox 
                              ...
                              TextMode="MultiLine"></asp:TextBox> 
                                   ...
                                   <br />
         <br />      
        <asp:Label ID="Label14" runat="server" Text="Rating:" Font-Names="Arial" 
             Font-Size="Medium"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="DropDownList7" 
         ...
         <br />
          &nbsp;&nbsp;&nbsp;&nbsp;<br />
                              <br />
         <asp:Button 
                 ID="Button5" runat="server" class="btn btn-outline-danger btn-fw" Height="40px" 
                             Text="Add Rating" onclick="Button5_Click"  
        Width="225px"/> &nbsp;&nbsp;
        ...
        <br />
          ...
          <footer class="footer">
            <<%--div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © bootstrapdash.com 20200</span>
