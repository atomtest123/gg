<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HotelUpdateParkingSlot.aspx.cs" Inherits="HotelUpdateParkingSlot" %>
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex">Hotel Add Parking Slot</h5>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <br />
         <br />
          <asp:Label ID="Label3" runat="server" Text="Slot ID:" Font-Bold="False" 
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="DropDownList1" 
                 runat="server" Width="225px" Height="29px" 
                              ...
                              &nbsp;&nbsp;&nbsp;<br />
         <br />
        <asp:Label ID="Label14" runat="server" Text="Parking Type:" Font-Names="Arial" 
             Font-Size="Medium"></asp:Label>
        &nbsp;&nbsp;&nbsp;<asp:TextBox 
                                  ID="TextBox1" runat="server" Height="26px" Width="225px"></asp:TextBox>&nbsp;&nbsp;&nbsp;
          ...
          <asp:Label ID="Label18" runat="server" Text="UserName:" Font-Bold="False" 
             Font-Names="Arial" Font-Size="Medium"></asp:Label>
                            &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;  <asp:TextBox 
                              ...
                              <br />
         <br />      
          <asp:Label ID="Label1" runat="server" Text="Update Slot:" Font-Bold="False" 
    Font-Names="Arial" Font-Size="Medium"></asp:Label>
                   &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;  <asp:TextBox 
           ...
           <br />      
          &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button 
                 ID="Button3" class="btn btn-outline-danger btn-fw" runat="server" Height="40px" Text="Update" onclick="Button1_Click"  
        Width="225px"/> 
