...
public partial class AdminDeleteMenu : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        string cmdstr = "select * from catgeory where status=0";
    ...
    protected void DataList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string sss = "update catgeory set status=1 where catid=" + id + "";
        ob1.exec(sss);
