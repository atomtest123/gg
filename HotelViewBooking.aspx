<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HotelViewBooking.aspx.cs" Inherits="HotelViewBooking" %>
            ...
            <%--  <div class="col-12 stretch-card grid-margin">--%>
             <%--   <div class="card card-secondary">--%>
                  <span class="card-body d-lg-flex align-items-center">
                    <div style="Width:1000px;text-align:left;padding-left: 20px;Width:1000px;">
                   <form id="form1" runat="server">
                    <div>
                    <br />
                    <br />
                      <%--asp:Label ID="Label14" runat="server" Text="Order Date:" Font-Names="Arial" 
                        ...
                        <tr>
                          ...
                          <td><%# Eval("timeslot")%></td>
                           ...
                           <td><%# Eval("floor")%></td>
                            <td><%# Eval("tamount")%></td>                        
                              <td>
               <asp:Button  ID="btn1" class="btn btn-outline-danger btn-fw" runat="server" CommandName="Select"  Text="View Orders" /> 
               </td>
                        </tr>
                ...
                <br />
                    <br />
                <asp:Label ID="Label2" runat="server" Text="Order Food Item:" Font-Names="Arial" 
             Font-Size="Medium"></asp:Label>
              <br />
      <asp:TextBox 
                                  ID="TextBox3" runat="server" Height="100px" Width="425px" 
          ...
          <asp:Label ID="Label5" runat="server" Text="No of items:" Font-Bold="False" 
             Font-Names="Arial" Font-Size="Medium"></asp:Label>
                         ...
                         <asp:TextBox 
                              ...
                              <br />
         <asp:Button 
                 ID="Button5" runat="server" class="btn btn-outline-danger btn-fw" Height="40px" Text="Update Food Items" onclick="Button5_Click"  
        Width="200px"/> &nbsp;&nbsp; <asp:Button 
                 ID="Button1" runat="server" class="btn btn-outline-danger btn-fw" Height="40px" Text="View Update Food" onclick="Button1_Click"  
        Width="200px"/>
        <br />
                    <br />
                 
                <asp:Label ID="Label19" runat="server" Text="Updated Food Item:" Font-Names="Arial" 
             Font-Size="Medium"></asp:Label>
                   
                    <br />
                
      <asp:TextBox 
                                  ID="TextBox13" runat="server" Height="100px" Width="425px" 
                              TextMode="MultiLine"></asp:TextBox> 
