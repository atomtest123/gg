<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminDeleteMenu.aspx.cs" Inherits="AdminDeleteMenu" %>
   ...
   <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex">Administrator Delete Menu</h5>
      ...
      <div class="container-fluid page-body-wrapper">
       ...
       <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        OnCancelCommand="DataList1_CancelCommand" DataKeyField="catid" onselectedindexchanged="DataList1_SelectedIndexChanged" >
